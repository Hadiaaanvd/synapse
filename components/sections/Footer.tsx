...
export default function Footer() {
  return (
    <footer className="bg-brand-gradient text-brand-white rounded-t-[3.4em] overflow-hidden">
      <div className="page-gutters py-8 md:py-10 lg:py-14 flex flex-col gap-8 text-xs sm:text-sm">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-8 gap-8 md:gap-12">
          <div className="flex-1 max-w-[220px] flex flex-col gap-4">
            ...
            <p className="text-white leading-relaxed">
              Stay in the loop and sign up for the Synapse newsletter.
            </p>
          </div>
